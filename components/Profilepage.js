...
function handleTakePhoto (dataUri) {
    ...
    <div className={styles.grid}>
        ...
        {arr.map(el => 
            ...
            <><Box  className="relative " bg='white' height='350px'><Image src={imageurl} fill sizes='auto'></Image><div className=" absolute w-full rounded-b-2xl -bottom-10 h-12 left-0 right-0 p-3 bg-white text-2xl"><div className="flex gap-6"><div>Delete</div></div></div></Box></>
        )}
