...
function Chatwindow() {
  return (
    <div className=" flex flex-col h-[80vh] h-[100vw]">
    ...
    <div  className="flex flex-col h-[75vh] bg-blue-50 w-full">
            ...
            <form className="flex align-center items-center justify-center bg-blue-50">
               ...
               <div  className="m-2 ml-0 mr-3 bg-blue-200 p-2 rounded-full pt-2 text-center cursor-pointer"><Image src='/matches.png' height={25} width={25}></Image></div> 
            </form> 
    </div>
